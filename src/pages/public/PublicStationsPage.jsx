...
import publicService from '@/services/public/publicService.js';
  ...
  const loadStations = async () => {
    ...
    try {
      const [res, vehiclesRes] = await Promise.all([
        publicService.getPublicStations(),
        publicService.getPublicVehicles()
      ]);
              ...
              <Card key={station.id} className="hover:shadow-lg transition-shadow duration-200">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex gap-2 pt-4">
                    ...
                    <Button
                      onClick={() => {
                        window.location.href = `/public/vehicles?station_id=${station.id}`;
                      }}
                      variant="outline"
                      size="sm"
                      className="flex-1"
